...
let roleId = {
  ...
  10000014: ["芭芭拉", "Barbara", "barbara", "闪耀偶像"],
  10000015: ["凯亚", "Kaeya", "kaeya", "凯子哥", "矿工头子", "骑兵队长", "凯子", "凝冰渡海真君"],
  10000016: ["迪卢克", "diluc", "Diluc", "卢姥爷", "姥爷", "卢老爷", "卢锅巴", "正义人", "正e人", "正E人", "暗夜英雄", "卢卢伯爵", "落魄了", "落魄了家人们"],
  10000020: ["雷泽", "razor", "Razor", "狼少年", "狼崽子", "狼崽", "卢皮卡", "小狼", "小狼狗", "狼孩"],
  10000021: ["安柏", "Amber", "amber", "安伯", "兔兔伯爵", "飞行冠军", "侦查骑士", "点火姬", "打火姬"],
  ...
  10000029: ["可莉", "逃跑的太阳", "Klee", "klee", "嘟嘟可", "火花骑士", "蹦蹦炸弹", "放火烧山", "放火烧山真君", "蒙德最强战力", "逃跑的太阳", "炸弹人", "小太阳"],
  10000030: ["钟离", "Zhongli", "zhongli", "摩拉克斯", "岩王爷", "岩神", "钟师傅", "天动万象", "岩王帝君", "帝君", "拒收病婿"],
  10000031: ["菲谢尔", "Fischl", "fischl", "皇女", "小艾米", "小艾咪", "奥兹", "断罪皇女", "中二少女", "中二皇女", "奥兹发射器", "小艾咪"],
  10000032: ["班尼特", "Bennett", "bennett", "点赞哥", "倒霉少年", "倒霉蛋", "霹雳闪雷真君", "班神", "班爷", "火神", "六星真神"],
  ...
  10000041: ["莫娜", "Mona", "mona", "莫纳", "占星术士", "占星师", "讨龙真君", "半部讨龙真君", "阿斯托洛吉斯·莫娜·梅姬斯图斯", "梅姬斯图斯", "梅姬斯图斯姬"],
  10000042: ["刻晴", "Keqing", "keqing", "刻情", "氪晴", "刻师傅", "刻师父", "牛杂", "牛杂师傅", "斩尽牛杂", "玉衡星", "阿晴", "啊晴", "璃月雷神"],
  ...
  10000046: ["胡桃", "Hu Tao", "hu tao", "HuTao", "hutao", "Hutao", "胡淘", "往生堂堂主", "核桃", "堂主", "胡堂主", "雪霁梅香", "桃"],
  10000047: ["枫原万叶", "Kaedehara Kazuha", "Kazuha", "kazuha", "万叶", "叶天帝", "天帝", "叶师傅"],
  10000048: ["烟绯", "Yanfei", "yanfei", "烟老师", "律师"],
  10000051: ["优菈", "Eula", "eula", "优拉", "尤拉", "尤菈", "浪花骑士", "劳伦斯"],

  //2.0
  10000002: ["神里绫华", "Kamisato Ayaka", "Ayaka", "ayaka", "神里", "绫华", "神里凌华", "凌华", "白鹭公主", "神里大小姐"],
  10000049: ["宵宫", "Yoimiya", "yoimiya", "霄宫", "烟花", "肖宫", "肖工"],
  ...
  10000050: ["托马", "Thoma", "thoma", "家政官", "地头蛇", "男仆", "拖马"],
  10000055: ["五郎", "Gorou", "gorou", "柴犬", "希娜", "希娜小姐"],
...
import { assignRoleId } from './myRoleId.js';
assignRoleId({ roleId, wifeData, abbr, abbr2, roleId5, roleId4, actWeapon, costumes });

 ...
 * 改这里可以把一局游戏的时间改长点
 */
const GAME_TIME_OUT = 30

/**
 * 猜角色 2.0 版本
 * 1. 新增角色长图，增加普通模式的难度
 * 2. 新增困难模式、地狱模式，进一步增加难度
 * 3. 新增本局游戏结束后，发送完整截图功能
 */
export const rule = {
  guessAvatar: {
...
const logoPath = path.join(_path, 'resources/genshin/logo/role');
const gachaPath = path.join(_path, 'resources/genshin/gacha/character');

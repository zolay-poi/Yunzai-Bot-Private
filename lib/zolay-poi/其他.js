...
import { init as initGlobal } from '../app/global.js';

const _path = process.cwd();
const globalImgPath = path.join(_path, 'resources/global_img');
...
export function updateGlobal(e) {
  if (!e.isMaster) return;
  let command = 'svn up ./Genshin';
  let options = { cwd: globalImgPath };

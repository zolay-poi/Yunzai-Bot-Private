...
import * as cjs from "../zolay-poi/猜角色.js";
import * as cyy from "../zolay-poi/猜语音.js";
...
export async function resources(e) {
  // 猜角色或猜语音时，不触发全局表情或语音
  if (cjs.getGuessConfig(e).playing) {
    return false;
  }
  if (cyy.getGuessConfig(e).playing) {
    return false;
  }
